...
VALUES
  (
    ...
    '[
      ...
      { "id": "get_any_author", "name": "Obtener cualquier autor" },
      { "id": "get_own_author", "name": "Obtener autor propio" },
      { "id": "create_category", "name": "Crear categoría" },
      { "id": "delete_category", "name": "Eliminar categoría" },
      { "id": "get_categories", "name": "Obtener categorías" },
      ...
      { "id": "get_any_collection", "name": "Obtener cualquier colección" },
      { "id": "get_own_collection", "name": "Obtener colección propia" },
      ...
      { "id": "get_own_publication", "name": "Obtener publicación propia" },
      { "id": "get_publication_reviews", "name": "Obtener calificaciones de publicación" },
      { "id": "get_unpublished_publications", "name": "Obtener publicaciones no publicadas" },
